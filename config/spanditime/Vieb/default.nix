      ...
      text = with colorscheme;''
        ...
        */
        :root {
            ...
            --mode-normal-bg: none;
            --mode-command-fg: ${base0D};
            --mode-command-bg: none;
            --mode-insert-fg: ${base0C};
            --mode-insert-bg: none;
            --mode-follow-fg: ${base0E};
            --mode-follow-bg: none;
            --mode-explore-fg: ${base0E};
            --mode-explore-bg: none;
            --mode-search-fg: ${base0D};
            --mode-search-bg: none;
            --mode-pointer-fg: ${base0A};
            --mode-pointer-bg: none;
            --mode-visual-fg: ${base0E};
            --mode-visual-bg: none;
            --url-default: ${base06};
            --url-search: ${base07};
            --url-searchwords: #fcf;
