{cfgPath, colorscheme, ...}:
{
  home.file = {
    ...
    "${cfgPath}/Vieb/colors/base16.css" = {
      enable = true;
      text = with colorscheme;''
        ...
        */
        :root {
            ...
            --bg: ${base00};
            --fg: ${base07};
            --tab-background: ${base02};
            --tab-suspended: ${base00};
            --visible-tab: ${base03};
            --tab-split: ${base0D};
            --tab-audio: ${base02};
            --tab-muted: ${base06};
            --tab-muted-playing: ${base05};
            --tab-crashed: ${base08};
            --tab-unresponsive: var(--tab-crashed);
            --tab-scrollbar: ${base06};
            --container-background: none;
            --mode-normal-fg: ${base07};
            --mode-normal-bg: none;
            --mode-command-fg: ${base00};
            --mode-command-bg: ${base0D};
            --mode-insert-fg: ${base00};
            --mode-insert-bg: ${base0C};
            --mode-follow-fg: ${base00};
            --mode-follow-bg: ${base0E};
            --mode-explore-fg: ${base00};
            --mode-explore-bg: ${base0E};
            --mode-search-fg: ${base00};
            --mode-search-bg: ${base0D};
            --mode-pointer-fg: ${base00};
            --mode-pointer-bg: ${base0A};
            --mode-visual-fg: ${base00};
            --mode-visual-bg: ${base0E};
            --url-default: ${base06};
            --url-search: ${base07};
            --url-searchwords: #fcf;
            --url-url: #3ff;
            ...
            --suggestions-border: ${base06};
            --suggestions-bg: ${base01};
            --suggestions-selected: ${base03};
            --suggestions-searchwords: ${base0F};
            --suggestions-url: ${base06};
            --suggestions-file: ${base06};
        ...
        */
        ...
        /* mouse related */
        #mode-suggestions {background: var(--bg);max-height: 0;position: absolute;left: 2em;top: 1.9em;padding-top: .1em;z-index: 37;overflow: hidden;display: inline-block;width: 7em;text-transform: capitalize;display: flex;flex-direction: column;}
